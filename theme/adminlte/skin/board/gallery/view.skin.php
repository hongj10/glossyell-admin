                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php if ($category_name) { ?><span class="btn btn-outline-secondary btn-xs float-left"><?php echo $view['ca_name']; // 분류 출력 끝 ?></span><?php } ?>
                            <h3 class="card-title">&nbsp; <?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?></h3>

                            <span class="mailbox-read-time float-right"><span class="sound_only">작성일</span>작성일: <?php echo date("Y-m-d H:i", strtotime($view['wr_datetime'])) ?></span>
                        ...
                        <div class="card-body">
                            <div id="bo_v_info">
                                <div class="profile_info mailbox-read-time">
                                    <span class="pf_img"><?php echo get_member_profile_img($view['mb_id']); ?></span>
                                    <span class="sound_only">작성자</span><span class="username">작성자: <a href="#"><?php echo $view['name']; ?></a><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></span><br>
                                    <span class="sound_only">댓글</span><a href="#bo_vc">댓 &nbsp;&nbsp; 글: <?php echo number_format($view['wr_comment']); ?>건</a><br>
                                    <span class="sound_only">조회</span><span class="description">조 &nbsp;&nbsp; 회: <?php echo number_format($view['wr_hit']); ?>회</span>
                                </div>
                                <!-- 게시물 상단 버튼 시작 { -->
	                            <div id="bo_v_top">                                
                                    <?php ob_start(); ?>
                            ...
                            <!-- 본문 내용 시작 { -->
                            <div class="card-body" id="bo_v_con"><?php echo get_view_thumbnail($view['content']); ?></div>
                            ...
                            <div>
                                ...
                                for ($i=1; $i<=count($view['link']); $i++) {
                                    ...
                                    ?>
                                    <!--div class="btn-block btn-outline-light float-left" -->
                                    <div class="card bg-light">
                                        <div class="card-body pt-0">
                                            <a href="<?php echo $view['link_href'][$i] ?>" target="_blank"><i class="fa fa-link" aria-hidden="true"></i> <strong><?php echo $link ?></strong></a>
                                            <span class="mailbox-read-time float-right"><?php echo $view['link_hit'][$i] ?>회 연결</span>
                                        </div>
                                    </div>
                                    <?php
                                    }
                            ...
                            <div>
                                ...
                                <?php if ($scrap_href) { ?><a href="<?php echo $scrap_href; ?>" target="_blank" class="btn btn-outline-info btn-sm" onclick="win_scrap(this.href); return false;"><i class="fa fa-bookmark" aria-hidden="true"></i> 스크랩</a><?php } ?>
                            </div>
                        </div>
                        <!-- /.card-body -->
                        ...
                        <div class="card-footer">
                            <?php if ($prev_href || $next_href) { ?>                            
                                <?php if ($prev_href) { ?><span class="btn_prv"><a href="<?php echo $prev_href; ?>"><span class="btn btn-outline-light btn-xs"><i class="fa fa-chevron-up" aria-hidden="true"></i> 이전글</span> &nbsp;&nbsp; <?php echo $prev_wr_subject;?></a> <span class="nb_date"><?php //echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span></span><?php } ?>
                                <?php if ($next_href) { ?><span class="btn_next"><a href="<?php echo $next_href; ?>"><span class="btn btn-outline-light btn-xs"><i class="fa fa-chevron-down" aria-hidden="true"></i> 다음글</span> &nbsp;&nbsp; <?php echo $next_wr_subject;?></a>  <span class="nb_date"><?php //echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span></span><?php } ?>
                            <?php } ?>
                        </div>
                        <!-- /.card-footer-->
                    </div>
