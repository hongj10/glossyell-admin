                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>제목</th>
                                        <th>글쓴이</th>
                                        <th style="width: 40px"><?php echo subject_sort_link('wr_hit', $qstr2, 1); ?>조회</a></th>
                                    ...
                                    <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class; ?>">
                                        ...
                                        <td>
                                            ...
                                            <span>
                                                ...
                                                <?php
                                                if ($list[$i]['icon_new']) { echo "&nbsp;<span class=\"btn btn-outline-light btn-xs\">New<span class=\"sound_only\">새글</span></span>"; }
                                                // if ($list[$i]['file']['count']) { echo '<'.$list[$i]['file']['count'].'>'; }
                                                if (isset($list[$i]['icon_hot'])) { echo "&nbsp;".rtrim($list[$i]['icon_hot']); }
                                                if (isset($list[$i]['icon_file'])) { echo "&nbsp;".rtrim($list[$i]['icon_file']); }
                                                if (isset($list[$i]['icon_link'])) { echo "&nbsp;".rtrim($list[$i]['icon_link']); }
                                                ?>
                                                <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span class="badge bg-warning"><?php echo $list[$i]['wr_comment']; ?></span><span class="sound_only">개</span><?php } ?>
                                            </span>
                                        </td>
