        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-edit"></i> 댓글 <code><?php echo $view['wr_comment']; ?></code></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="card card-light card-outline">
                        <div class="card-header">
                            <div id="bo_v_info">
                                <span class="profile_info mailbox-read-time">
                                    <span class="pf_img"><?php echo get_member_profile_img($list[$i]['mb_id']); ?></span>
                                    <span class="sound_only">작성자</span><span class="username">작성자: <a href="#"><?php echo $list[$i]['name'] ?></a><?php if ($is_ip_view) { echo "&nbsp;(".$list[$i]['ip'].")"; } ?></span><br>
                    ...
                    <form name="fviewcomment" id="fviewcomment" action="<?php echo $comment_action_url; ?>" onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off">
                        ...
                        <div class="bo_vc_w_wr">
                            ...
                            <div class="btn_confirm">
                                ...
                                <button type="submit" id="btn_submit" class="btn btn-info btn-sm">댓글등록</button>
                            </div>
                        </div>
                    </form>
                </aside>
